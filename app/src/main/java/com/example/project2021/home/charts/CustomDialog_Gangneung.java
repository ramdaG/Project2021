...
public class CustomDialog_Gangneung extends Dialog {
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (testTxt.getBytes().length <= 0) {
                    ...
                    mFirestore.collection("comments_Gangneung").add(testMap).addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                        @Override
    ...
    public CustomDialog_Gangneung(Context mContext) {
        super(mContext);

...
public class CustomDialog_Jeonju extends Dialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mFirestore.collection("comments_Jeonju").add(testMap).addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                    @Override
                ...
                switch (radioGroup.getCheckedRadioButtonId()){
                    case R.id.rb_Coat:System.out.println("a");
                        myRef.child("Charts").child("Jeonju").child(mCoat).child(uid).setValue("");
                        break;
                    case R.id.rb_Long:System.out.println("b");
                        myRef.child("Charts").child("Jeonju").child(mLong).child(uid).setValue("");
                        break;
                    case R.id.rb_Short:System.out.println("c");
                        myRef.child("Charts").child("Jeonju").child(mShort).child(uid).setValue("");
                        break;
                }
    ...
    public CustomDialog_Jeonju(Context mContext) {
        super(mContext);

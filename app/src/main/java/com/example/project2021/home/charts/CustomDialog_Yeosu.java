...
public class CustomDialog_Yeosu extends Dialog {
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (testTxt.getBytes().length <= 0) {
                    ...
                    mFirestore.collection("comments_Yeosu").add(testMap).addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                        @Override
                    ...
                    switch (radioGroup.getCheckedRadioButtonId()) {
                        case R.id.rb_Coat:
                            ...
                            myRef.child("Charts").child("Yeosu").child(mCoat).child(uid).setValue("");
                            break;
                        case R.id.rb_Long:
                            System.out.println("b");
                            myRef.child("Charts").child("Yeosu").child(mLong).child(uid).setValue("");
                            break;
                        case R.id.rb_Short:
                            System.out.println("c");
                            myRef.child("Charts").child("Yeosu").child(mShort).child(uid).setValue("");
                            break;
                    }
    ...
    public CustomDialog_Yeosu(Context mContext) {
        super(mContext);

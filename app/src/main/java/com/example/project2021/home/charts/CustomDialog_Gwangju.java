...
public class CustomDialog_Gwangju extends Dialog {
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (testTxt.getBytes().length <= 0) {
                    ...
                    mFirestore.collection("comments_Gwangju").add(testMap).addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                        @Override
                    ...
                    switch (radioGroup.getCheckedRadioButtonId()) {
                        case R.id.rb_Coat:
                            ...
                            myRef.child("Charts").child("Gwangju").child(mCoat).child(uid).setValue("");
                            break;
                        case R.id.rb_Long:
                            System.out.println("b");
                            myRef.child("Charts").child("Gwangju").child(mLong).child(uid).setValue("");
                            break;
                        case R.id.rb_Short:
                            System.out.println("c");
                            myRef.child("Charts").child("Gwangju").child(mShort).child(uid).setValue("");
                            break;
                    }
    ...
    public CustomDialog_Gwangju(Context mContext) {
        super(mContext);

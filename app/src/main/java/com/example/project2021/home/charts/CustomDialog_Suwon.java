...
public class CustomDialog_Suwon extends Dialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mFirestore.collection("comments_Suwon").add(testMap).addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                    @Override
                ...
                switch (radioGroup.getCheckedRadioButtonId()){
                    case R.id.rb_Coat:System.out.println("a");
                        myRef.child("Charts").child("suwon").child(mCoat).child(uid).setValue("");
                        break;
                    case R.id.rb_Long:System.out.println("b");
                        myRef.child("Charts").child("suwon").child(mLong).child(uid).setValue("");
                        break;
                    case R.id.rb_Short:System.out.println("c");
                        myRef.child("Charts").child("suwon").child(mShort).child(uid).setValue("");
                        break;
                }
    ...
    public CustomDialog_Suwon(Context mContext) {
        super(mContext);

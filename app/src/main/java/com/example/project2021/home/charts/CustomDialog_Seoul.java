...
public class CustomDialog_Seoul extends Dialog {
            ...
            public void onClick(View v) {
                ...
                switch (radioGroup.getCheckedRadioButtonId()){
                    case R.id.rb_Coat:System.out.println("a");
                        myRef.child("Charts").child("seoul").child(mCoat).child(uid).setValue("");
                        break;
                    case R.id.rb_Long:System.out.println("b");
                        myRef.child("Charts").child("seoul").child(mLong).child(uid).setValue("");
                        break;
                    case R.id.rb_Short:System.out.println("c");
                        myRef.child("Charts").child("seoul").child(mShort).child(uid).setValue("");
                        break;
                }
    ...
    public CustomDialog_Seoul(Context mContext) {
        super(mContext);
